...
namespace LoginSenha.Data.Extensions
{
    public static class ModelBuilderExtension
    {
        ...
        public static ModelBuilder SeedData(this ModelBuilder builder)
        {
            builder.Entity<User>()
                .HasData(
                    new User { Id = Guid.Parse("c7dce21b-d207-4869-bf5f-08eb138bb919"), Name = "User Default", Email = "userdefault@LoginSenha.com", DateCreated = new DateTime(2020,2,2), IsDeleted = false, DateUpdated = null }
                );
